...
static Key keys[] = {
	...
	{ 0,                       	XK_Print,      	  spawn,   SHCMD("import -window root scr$(date +%s).png") },
	{ ControlMask,                 	XK_Print,      	  spawn,   SHCMD("import scr$(date +%s).png") },
	...
	{ 0,                XF86XK_MonBrightnessDown,     spawn,   SHCMD("brightnessctl s 2%- -q") },
	{ 0,                XF86XK_MonBrightnessUp,       spawn,   SHCMD("brightnessctl s +1% -q") },
	{ 0,                XF86XK_Display,	   spawn,          SHCMD("xset dpms force off") },
	/*{ 0,                XF86Battery,	   spawn,          SHCMD("") },*/
